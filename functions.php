...
if ( ! function_exists( 'visualcomposerstarter_style_switch_toggle_acf' ) ) {
    ...
    function visualcomposerstarter_style_switch_toggle_acf()
    {
        ...
        if (isset($screen->base) && 'post' === $screen->base) {
            $font_uri = VisualComposerStarter_Fonts::vct_theme_get_google_font_uri(['Open Sans']);
            wp_register_style('visualcomposerstarter-toggle-acf-fonts', $font_uri);
            wp_enqueue_style('visualcomposerstarter-toggle-acf-fonts');

            wp_register_style(
                'visualcomposerstarter-toggle-acf-style',
                get_template_directory_uri() . '/css/toggle-switch.css',
                [],
                false
            );
...
if ( ! function_exists( 'visualcomposerstarter_script_switch_toggle_acf' ) ) {
    ...
    function visualcomposerstarter_script_switch_toggle_acf()
    {
        ...
        if (isset($screen->base) && 'post' === $screen->base) {
            wp_register_script(
                'visualcomposerstarter-toggle-acf-script',
                get_template_directory_uri() . '/js/toggle-switch-acf.js',
                ['jquery'],
                false,
                true
            );
...
if ( ! function_exists( 'visualcomposerstarter_style' ) ) {
    ...
    function visualcomposerstarter_style()
    {
        ...
        wp_register_style('bootstrap', get_template_directory_uri() . '/css/bootstrap.min.css', [], '3.3.7');

        /* Add Visual Composer Starter Font */
        wp_register_style(
            'visualcomposerstarter-font',
            get_template_directory_uri() . '/css/visual-composer-starter-font.min.css',
            [],
        ...
        wp_register_style(
            'visualcomposerstarter-responsive',
            get_template_directory_uri() . '/css/responsive.min.css',
            [],
            VISUALCOMPOSERSTARTER_VERSION
        );
        ...
        /* Load Google Fonts */
        wp_register_style('visualcomposerstarter-fonts', $font_uri, [], null, 'screen');
...
if ( ! function_exists( 'visualcomposerstarter_script' ) ) {
    ...
    function visualcomposerstarter_script()
    {
        ...
        wp_register_script(
            ...
            get_template_directory_uri() . '/js/bootstrap/transition.min.js',
            ['jquery'],
            '3.3.7',
            true
        );
        ...
        wp_register_script(
            'bootstrap-collapser',
            get_template_directory_uri() . '/js/bootstrap/collapse.min.js',
            ['jquery'],
            '3.3.7',
            true
        );
...
if ( ! function_exists( 'visualcomposerstarter_customizer_live_preview' ) ) {
    ...
    {
        wp_enqueue_script(
            'visualcomposerstarter-themecustomizer',
...
if ( ! function_exists( 'visualcomposerstarter_set_old_styles' ) ) {
    /**
...
if ( ! function_exists( 'visualcomposerstarter_woo_categories' ) ) {
    ...
    function visualcomposerstarter_woo_categories()
    {
        ...
        echo wc_get_product_category_list(
            $product->get_id(),
            ' ',
            '<div class="entry-categories"><span class="screen-reader-text">' . _n(
                'Category:',
                'Categories:',
...
if ( ! function_exists( 'visualcomposerstarter_woo_tags' ) ) {
    ...
    function visualcomposerstarter_woo_tags()
    {
        ...
        echo wc_get_product_tag_list(
            $product->get_id(),
            ' ',
            '<div class="entry-tags"><span class="screen-reader-text">' . _n(
                'Tag:',
                'Tags:',
                count(
                    $product->get_tag_ids()
...
if ( ! function_exists( 'visualcomposerstarter_woo_format_sale_price' ) ) {
    ...
    {
        $price = '<ins>' . (is_numeric($sale_price) ? wc_price($sale_price) : $sale_price) . '</ins> <del>'
            . (is_numeric($regular_price) ? wc_price($regular_price) : $regular_price) . '</del>';
