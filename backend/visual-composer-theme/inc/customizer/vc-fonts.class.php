...
Class VC_Fonts {
    ...
    {
        $heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'visual-composer-theme' ) ) ) );
        $standard_fonts = self::vc_theme_standard_fonts();
        $heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'visual-composer-theme' ) ) ) );
    ...
    public static function vc_theme_font_subsets() {
        return array(
            'all'          => __( 'All', 'visual-composer-theme' ),
            'cyrillic'     => __( 'Cyrillic', 'visual-composer-theme' ),
            'cyrillic-ext' => __( 'Cyrillic Extended', 'visual-composer-theme' ),
            'devanagari'   => __( 'Devanagari', 'visual-composer-theme' ),
            'greek'        => __( 'Greek', 'visual-composer-theme' ),
            'greek-ext'    => __( 'Greek Extended', 'visual-composer-theme' ),
            'khmer'        => __( 'Khmer', 'visual-composer-theme' ),
            'latin'        => __( 'Latin', 'visual-composer-theme' ),
            'latin-ext'    => __( 'Latin Extended', 'visual-composer-theme' ),
            'vietnamese'   => __( 'Vietnamese', 'visual-composer-theme' ),
        );
    }
