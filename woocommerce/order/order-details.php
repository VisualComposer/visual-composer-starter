...
<section class="woocommerce-order-details">
	<div class="vct-order-container">
		<h3 class="woocommerce-order-details__title"><?php _e( 'Order details', 'visual-composer-starter' ); ?></h3>

		<ul class="vct-order-details-container">

			<li class="vct-order-detail">
				<span><?php _e( 'Order number:', 'visual-composer-starter' ); ?></span>
				<span><?php echo $order->get_order_number(); ?></span>
			</li>
			<li class="vct-order-detail">
				<span><?php _e( 'Date:', 'visual-composer-starter' ); ?></span>
	        ...
	        <?php if ( $order->get_customer_note() ) : ?>
				<li class="vct-order-detail">
					<span><?php _e( 'Note:', 'woocommerce' ); ?></span>
...
if ( $show_customer_details ) {
	wc_get_template( 'order/order-details-customer.php', array( 'order' => $order, 'order_id' => $order_id ) );
}
