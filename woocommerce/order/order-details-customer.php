...
<section class="woocommerce-customer-details">
	<h2 class="woocommerce-column__title"><?php _e( 'Billing address', 'visual-composer-starter' ); ?></h2>
	...
	<ul class="vct-billing-details-container">
        ...
        <?php if ( $order->get_billing_city() || $order->get_billing_address_1() || $order->billing_address_2() ) : ?>
			<li class="vct-billing-detail">
				<span><?php _e( 'Address', 'visual-composer-starter' ); ?></span>
				<span>
					<?php
        ...
        <?php if ( $order->get_billing_postcode() ) : ?>
			<li class="vct-billing-detail">
				<span><?php _e( 'Postal Code', 'visual-composer-starter' ); ?></span>
