...
Class VCT_Fonts {
    ...
    {
        $heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Standard Fonts', 'visual-composer-starter' ) ) ) );
        $standard_fonts = self::vct_theme_standard_fonts();
        $heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', esc_html__( 'Google Fonts', 'visual-composer-starter' ) ) ) );
