	...
	function visualcomposerstarter_entry_meta() {
		...
		<ul class="entry-meta">
			...
			<?php if ( 'post' === get_post_type() ) : ?>
				<li class="entry-meta-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><span class="author vcard"><?php $author = get_the_author(); esc_html_e($author); ?></span></a></li>
			<?php endif; ?>
			...
			<div class="entry-meta">
				<?php if ( in_array( get_post_type(), array(
					...
					<?php if ( 'post' === get_post_type() ) : ?>
						...
						<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><span class="author vcard"><?php $author = get_the_author(); esc_html_e($author); ?></span></a>
					<?php endif; ?>
				<?php endif; ?>
